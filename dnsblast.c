...
get_random_ptr(char * const name, size_t name_size)
{
    ...
    const float r1 = rand() / paddy, r2 = 256 * rand() / paddy, r3 = 256 * rand() / paddy, r4 = 256 * rand() / paddy;
    printf("%f %f %f %f\n",r1,r2,r3,r4);
    char hammer[1000];
    sprintf(hammer, "%f", 256 * r1);
    name[0] = hammer[0];
    name[1] = hammer[1];
    name[2] = hammer[2];
    //name[3] = '.';
    sprintf(hammer, "%f", 256 * r2);
    name[4] = hammer[0];
    name[5] = hammer[1];
    name[6] = hammer[2];
    //name[7] = '.';
    sprintf(hammer, "%f", 256 * r3);
    name[8] = hammer[0];
    name[9] = hammer[1];
    name[10] = hammer[2];
    //name[11] = '.';
    sprintf(hammer, "%f", 256 * r4);
    name[12] = hammer[0];
    name[13] = hammer[1];
    name[14] = hammer[2];
